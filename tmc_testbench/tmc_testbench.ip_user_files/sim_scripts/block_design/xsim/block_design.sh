...
#
# Script generated by Vivado on Mon Mar 09 20:29:40 -0700 2026
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L axi_uartlite_v2_0_39 -L axi_timer_v2_0_37 -L microblaze_v11_0_16 -L lmb_v10_v3_0_16 -L lmb_bram_if_cntlr_v4_0_27 -L blk_mem_gen_v8_4_12 -L mdm_v3_2_29 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_36 -L axi_vip_v1_1_22 -L gigantic_mux -L xlconcat_v2_1_7 -L axi_bram_ctrl_v4_1_13 -L axi_datamover_v5_1_37 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot block_design xil_defaultlib.block_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim block_design -key {Behavioral:sim_1:Functional:block_design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_70a8.protoinst" -protoinst "protoinst_files/bd_e8a5.protoinst" -protoinst "protoinst_files/bd_2da4.protoinst" -protoinst "protoinst_files/block_design.protoinst" -log simulate.log
}
