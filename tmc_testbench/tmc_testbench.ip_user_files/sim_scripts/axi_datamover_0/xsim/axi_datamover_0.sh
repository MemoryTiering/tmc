...
#
# Script generated by Vivado on Tue Mar 03 17:34:09 -0800 2026
...
#
# Usage        : axi_datamover_0.sh
#                axi_datamover_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_datamover_0.sh [-rerun]
#                axi_datamover_0.sh [-reset_run]
#                axi_datamover_0.sh [-clean]
#                axi_datamover_0.sh [-reset_log]
#                axi_datamover_0.sh [-help]
#
...
# script info
echo -e "axi_datamover_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_datamover_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_datamover_v5_1_37 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_datamover_0 xil_defaultlib.axi_datamover_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_datamover_0 -key {Behavioral:sim_1:Functional:axi_datamover_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_70a8.protoinst" -protoinst "protoinst_files/bd_e8a5.protoinst" -protoinst "protoinst_files/bd_2da4.protoinst" -protoinst "protoinst_files/block_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_datamover_0.wdb xsim.dir libdpi.so)
...
Usage: axi_datamover_0.sh [-step]\n\
Usage: axi_datamover_0.sh [-lib_map_path]\n\
Usage: axi_datamover_0.sh [-rerun]\n\
Usage: axi_datamover_0.sh [-reset_run]\n\
Usage: axi_datamover_0.sh [-clean]\n\
Usage: axi_datamover_0.sh [-reset_log]\n\
Usage: axi_datamover_0.sh [-keep_index]\n\
