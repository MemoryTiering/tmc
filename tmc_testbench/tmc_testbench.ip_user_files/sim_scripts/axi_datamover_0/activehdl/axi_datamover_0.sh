...
#                script (type 'axi_datamover_0.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Donov/Projects/tmc/tmc_testbench/tmc_testbench.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
