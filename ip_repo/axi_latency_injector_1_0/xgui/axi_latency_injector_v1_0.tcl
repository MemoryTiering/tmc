...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_LATENCY_CYCLES"
...
proc update_PARAM_VALUE.C_LATENCY_CYCLES { PARAM_VALUE.C_LATENCY_CYCLES } {
	# Procedure called to update C_LATENCY_CYCLES when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_LATENCY_CYCLES { PARAM_VALUE.C_LATENCY_CYCLES } {
	# Procedure called to validate C_LATENCY_CYCLES
	return true
}
...
proc update_MODELPARAM_VALUE.C_LATENCY_CYCLES { MODELPARAM_VALUE.C_LATENCY_CYCLES PARAM_VALUE.C_LATENCY_CYCLES } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_LATENCY_CYCLES}] ${MODELPARAM_VALUE.C_LATENCY_CYCLES}
}
